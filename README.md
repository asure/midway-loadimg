...
### v0.96 (Latest)
- **CARN /OLD2 fully passes** (13/13) — Total Carnage support complete. memcmp-verified dedup with ANIX-only scoping, SIZX uses IMG_STRIDE(w) for TBL output, all 13 TBLs match reference.
...
| **CARN** | /OLD2 | **PASS** (13/13) | All TBLs pass. memcmp-verified dedup with ANIX-only check. |
...
| (none) | | CARN /OLD2 fully passes (13/13) |

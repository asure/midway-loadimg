...
| **BB7** | Mixed | FAIL (15/16) | OUTDOOR LEAF8 dedup (unused image) |
| **BB8** | XON | **PASS** (3/3) | |
...
| **BB7 OUTDOOR LEAF8 dedup** | BB7 | LEAF8 (unused image) not deduped to LEAF7; ref generated with different data |

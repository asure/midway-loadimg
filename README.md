...
### v0.97 (Latest)
- **16 pass, 6 fail** — stable baseline. All modern (LOADW) tests pass except pre-existing MK7, BB7.
...
- **Full regression testing** — `bash test.sh` after every change ensures 16 pass baseline.
